...
namespace quadwar_app
{
    ...
    class root : public engine::entity
    {
    public:
        root() = default;
        ...
        static void slot_create(engine::access::entity en, size_t id_actor);
        static void slot_remove(engine::access::entity en, size_t id_actor);

        static auto get_slot_count(engine::access::entity en) -> size_t;
        static auto get_slot(engine::access::entity en, size_t index) -> size_t;
