...
void mainmenu::on_create(mainmenu::event_create ev) {
  m_c_continue->on_click([=](ui::ptr_widget) {
    ...
    info.player_count =
        to_integer(m_c_player_count->get_text());
...
void mainmenu::adjust_layout(size_t width, size_t height) {
  ...
  m_info->set_rect(ui::rect { static_cast<int>(x0 + spacing),
      static_cast<int>(y0 + spacing), menu_width - spacing * 2,
      info_height - spacing * 2 });

  auto lines_rect =
      ui::rect { x0, static_cast<int>(y0 + info_height),
  ...
  m_create->set_rect(ui::rect { static_cast<int>(spacing),
      static_cast<int>(spacing), menu_width - spacing * 2,
      line_height - spacing * 2 });

  m_join->set_rect(ui::rect { static_cast<int>(spacing),
      static_cast<int>(spacing + line_height),
      menu_width - spacing * 2, line_height - spacing * 2 });

  m_quit->set_rect(ui::rect { static_cast<int>(spacing),
  ...
  m_c_player_name_label->set_rect(
      ui::rect { static_cast<int>(spacing),
          static_cast<int>(spacing + line_height),
          half_menu_width - spacing * 2,
          line_height - spacing * 2 });

  m_c_player_name->set_rect(
      ui::rect { static_cast<int>(spacing + half_menu_width),
          static_cast<int>(spacing + line_height),
          half_menu_width - spacing * 2,
          line_height - spacing * 2 });
  ...
  m_c_cancel->set_rect(ui::rect { static_cast<int>(spacing),
  ...
  m_j_cancel->set_rect(ui::rect { static_cast<int>(spacing),
      static_cast<int>(spacing + line_height * 3),
      half_menu_width - spacing * 2,
      line_height - spacing * 2 });
