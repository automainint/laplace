...
{
    class request_events final : public impact
    {
    public:
         ...
         */
        static constexpr auto max_event_count = (max_size - n_events) / event_size;
        ...
        {
            return as_index(rd<uint64_t>(seq, n_events + index * event_size));
        }
