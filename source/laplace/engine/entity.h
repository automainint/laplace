...
namespace laplace::engine
{
    ...
    public:
        ...
        entity(cref_entity en);
        entity(entity &&en) noexcept;
        auto operator =(cref_entity en) -> ref_entity;
        auto operator =(entity &&en) noexcept -> ref_entity;

        /*  Prototype initialization.
         */
        entity(proto_tag = proto);
    ...
    protected:
         ...
         */
        virtual auto do_request(size_t id, cref_vbyte args) const -> vbyte;
