...
namespace laplace::stem::config
{
    ...
    constexpr auto default_shader_flat_solid_vertex     = u8"flat/solid.vert";
    constexpr auto default_shader_flat_solid_fragment   = u8"flat/solid.frag";
    constexpr auto default_shader_flat_sprite_vertex    = u8"flat/sprite.vert";
    constexpr auto default_shader_flat_sprite_fragment  = u8"flat/sprite.frag";

    auto scan_flag(int argc, char **argv, char c) -> bool;
    auto scan_flag(int argc, char **argv, std::string_view name) -> bool;
    auto scan_flag(int argc, char **argv, char c, std::string_view name) -> bool;

    auto get_default() -> core::family;

    auto load(int argc, char **argv, core::cref_family def_cfg = get_default()) -> core::family;
