...
namespace laplace::math
{
    ...
    public:
        ...
        vector<valcount, vecval> &operator +=(const vector<valcount, vecval> &v);
        vector<valcount, vecval> &operator -=(const vector<valcount, vecval> &v);
    ...
    public:
        ...
        explicit constexpr vector(vecval v);
        explicit constexpr vector(const vecval *v);
        explicit constexpr vector(const vector<2, vecval> &v, vecval z);
        explicit constexpr vector(const vector<4, vecval> &v);
    ...
    public:
        ...
        union {
            struct { vecval x, y, z, w; };
            struct { vecval red, green, blue, alpha; };
            struct { vecval v[4]; };
        };
        ...
        explicit constexpr vector(vecval v);
        explicit constexpr vector(const vecval *v);
        explicit constexpr vector(const vector<2, vecval> &v, vecval z, vecval w);
        explicit constexpr vector(const vector<3, vecval> &v, vecval w);
    ...
    template <size_t valcount, typename vecval>
    vector<valcount, vecval> operator +(const vector<valcount, vecval> &u, const vector<valcount, vecval> &v);

    template <size_t valcount, typename vecval>
    vector<valcount, vecval> operator -(const vector<valcount, vecval> &u, const vector<valcount, vecval> &v);

    template <size_t valcount, typename vecval>
    vector<valcount, vecval> operator *(const vector<valcount, vecval> &v, vecval d);
    ...
    template <size_t valcount, typename vecval>
    vector<valcount, vecval> operator *(vecval d, const vector<valcount, vecval> &v);

    template <size_t valcount, typename vecval>
    auto operator ==(const vector<valcount, vecval> &a, const vector<valcount, vecval> &b) -> bool;
    ...
    template <size_t valcount, typename vecval>
    vecval dot(const vector<valcount, vecval> &u, const vector<valcount, vecval> &v);
    ...
    template <typename vecval>
    vector<3, vecval> cross(const vector<3, vecval> &u, const vector<3, vecval> &v);

    template <size_t valcount, typename vecval>
    vector<valcount, vecval> project(const vector<valcount, vecval> &vec, const vector<valcount, vecval> norm);

    template <typename vecval>
    vector<2, vecval> rotate(const vector<2, vecval> &v, const complex<vecval> &a);

    template <typename vecval>
    vector<3, vecval> rotate(const vector<3, vecval> &v, const quaternion<vecval> &q);

    template <typename vecval>
    vector<4, vecval> rotate(const vector<4, vecval> &v, const quaternion<vecval> &q);
}
