...
family::family(cref_vfamily value) { assign(value); }

family::family(cref_composite value) { assign(value); }

family::family(bool value) { assign(value); }
...
family::family(double value) { assign(value); }

family::family(string_view value) { assign(value); }

family::family(wstring_view value) { assign(value); }

family::family(u8string_view value) { assign(value); }

family::family(u16string_view value) { assign(value); }

family::family(u32string_view value) { assign(value); }
...
family::family(cref_vbyte value) { assign(value); }
...
family::operator bool() const { return get_boolean(); }

family::operator int64_t() const { return get_integer(); }

family::operator double() const { return get_real(); }

family::operator uint64_t() const { return get_uint(); }

family::operator u8string_view() const { return get_string(); }
...
auto family::has(cref_family key) const -> bool {
  ...
  auto i = lower_bound(get<n_composite>(m_data).begin(),
      get<n_composite>(m_data).end(), key, op_lower_bound);
...
void family::set_key(size_t index, cref_family k) {
  ...
  auto i = lower_bound(get<n_composite>(m_data).begin(),
      get<n_composite>(m_data).end(), k, op_lower_bound);
...
auto family::by_key(size_t key) -> ref_family {
  ...
  auto i = lower_bound(get<n_composite>(m_data).begin(),
      get<n_composite>(m_data).end(), key, op_lower_bound_uint);
...
void family::assign(bool value) { m_data = value; }

void family::assign(int64_t value) { m_data = value; }

void family::assign(uint64_t value) { m_data = value; }

void family::assign(double value) { m_data = value; }
...
auto family::op_lower_bound(
    const pair<family, family> &a, const family &key) -> bool {
  return a.first < key;
}

auto family::op_lower_bound_uint(
    const pair<family, family> &a, size_t key) -> bool {
