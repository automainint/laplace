...
TEST(laplace_core, family_construct)
{
    EXPECT_TRUE(family().is_empty());
    EXPECT_TRUE(family { }.is_empty());
    EXPECT_TRUE(family(vfamily { family() }).is_vector());
    EXPECT_TRUE(family(composite { { family(), family() } }).is_composite());
...
TEST(laplace_core, family_assign)
{
    family f;
...
TEST(laplace_core, family_compare)
{
    ...
    EXPECT_TRUE(family(vbyte { 0 }) < family(vfamily { family() }));
    EXPECT_TRUE(family(vfamily { family() }) < family(composite { { family(), family() } }));
    ...
    EXPECT_TRUE(family(vfamily { family(0), family(1), family(2) }) == family(vfamily { family(0), family(1), family(2) }));
    EXPECT_TRUE(family(vfamily { family(0), family(1) }) < family(vfamily { family(0), family(1), family(2) }));
    EXPECT_TRUE(family(vfamily { family(0), family(1), family(2) }) < family(vfamily { family(1), family(2) }));
    EXPECT_TRUE(family(vfamily { family(0), family(1), family(2) }) < family(vfamily { family(1), family(0) }));

    EXPECT_TRUE(family(composite { { family(0), family(1) } }) == family(composite { { family(0), family(1) } }));
    EXPECT_TRUE(family(composite { { family(0), family(1) } }) < family(composite { { family(0), family(1) }, { family(2), family(3) } }));
    EXPECT_TRUE(family(composite { { family(0), family(1) }, { family(2), family(3) } }) < family(composite { { family(2), family(3) } }));
}

TEST(laplace_core, family_nothrow)
{
    family f;
    const family cf;
