...
namespace laplace::test {
  ...
  TEST("state apply allocate int and get") {
    ...
    REQUIRE(s.apply(impact { integer_allocate { 1, ret, 0 } }));
    while (s.adjust()) { }
  ...
  TEST("state apply reserve int and allocate") {
    ...
    REQUIRE(s.apply(impact { integer_reserve { reserved } }));
    REQUIRE(s.apply(impact { integer_allocate_into { ret, 2 } }));
    REQUIRE(s.apply(impact { integer_allocate { 1, ret, 0 } }));
    REQUIRE(s.apply(impact { integer_allocate { 1, ret, 1 } }));
    while (s.adjust()) { }
  ...
  TEST("state apply allocate int, set and get") {
    ...
    auto id = s.get_integer(ret, 0, -1);
    REQUIRE(id != -1);
    REQUIRE(s.apply(impact { integer_set { id, 0, 42 } }));
    while (s.adjust()) { }
  ...
  TEST("state apply add int") {
    ...
    auto id = ptrdiff_t { 0 };
    REQUIRE(s.apply(impact { integer_allocate_into { id, 1 } }));
    REQUIRE(s.apply(impact { integer_add { id, 0, 18 } }));
    REQUIRE(s.apply(impact { integer_add { id, 0, 24 } }));
    while (s.adjust()) { }
    REQUIRE(s.get_integer(id, 0, -1) == 42);
  }
  ...
  TEST("state apply allocate byte and get") {
    ...
    auto ret = ptrdiff_t { 0 };
    REQUIRE(s.apply(impact { integer_allocate_into { ret, 1 } }));
    REQUIRE(s.apply(impact { byte_allocate { 1, ret, 0 } }));
    while (s.adjust()) { }
    auto id = s.get_integer(ret, 0, -1);
    REQUIRE(id != -1);
    REQUIRE(s.get_byte(id, 0, -1) == 0);
  ...
  TEST("state apply allocate byte, set and get") {
    ...
    auto id = s.get_integer(ret, 0, -1);
    REQUIRE(id != -1);
    REQUIRE(s.apply(impact { byte_set { id, 0, 42 } }));
    while (s.adjust()) { }
  ...
  TEST("state apply reserve byte and allocate") {
    ...
    ptrdiff_t reserved = 10;
    REQUIRE(s.apply(impact { integer_allocate_into { ret, 2 } }));
    REQUIRE(s.apply(impact { byte_reserve { reserved } }));
    REQUIRE(s.apply(impact { byte_allocate { 1, ret, 0 } }));
    REQUIRE(s.apply(impact { byte_allocate { 1, ret, 1 } }));
    while (s.adjust()) { }
    REQUIRE(s.get_integer(ret, 0, -1) == reserved);
    REQUIRE(s.get_integer(ret, 1, -1) == reserved + 1);
  }
  ...
  TEST("state apply add byte") {
    ...
    auto id = ptrdiff_t { 0 };
    REQUIRE(s.apply(impact { byte_allocate_into { id, 1 } }));
    REQUIRE(s.apply(impact { byte_add { id, 0, 18 } }));
    REQUIRE(s.apply(impact { byte_add { id, 0, 24 } }));
    while (s.adjust()) { }
    REQUIRE(s.get_byte(id, 0, -1) == 42);
  }
  ...
  TEST("state apply random") {
    ...
    REQUIRE(s.apply(impact { integer_allocate_into { id, size } }));
    REQUIRE(
  ...
  TEST("state random with equal seed") {
    ...
    auto id   = ptrdiff_t { 0 };
    auto size = ptrdiff_t { 1000 };
    REQUIRE(foo.apply(impact { integer_seed { 42 } }));
    REQUIRE(bar.apply(impact { integer_seed { 42 } }));
    REQUIRE(foo.apply(impact { integer_allocate_into { id, size } }));
    REQUIRE(bar.apply(impact { integer_allocate_into { id, size } }));
    REQUIRE(
        foo.apply(impact { integer_random { 1, 100, id, 0, size } }));
    REQUIRE(
  ...
  TEST("state random with different seed") {
    ...
    auto size = ptrdiff_t { 1000 };
    REQUIRE(foo.apply(impact { integer_seed { 42 } }));
    REQUIRE(bar.apply(impact { integer_seed { 43 } }));
    REQUIRE(foo.apply(impact { integer_allocate_into { id, size } }));
    REQUIRE(bar.apply(impact { integer_allocate_into { id, size } }));
    REQUIRE(
        foo.apply(impact { integer_random { 1, 100, id, 0, size } }));
  ...
  TEST("state allocation determinism") {
    ...
    REQUIRE(s.apply(impact { integer_allocate_into { id, 5 } }));
    REQUIRE(s.apply(impact { integer_allocate { 10, id, 0 } }));
    REQUIRE(s.apply(impact { integer_allocate { 20, id, 1 } }));
    REQUIRE(s.apply(impact { integer_allocate { 30, id, 2 } }));
    ...
    REQUIRE(s.apply(
        impact { integer_deallocate { s.get_integer(id, 0, -1) } }));
    REQUIRE(s.apply(impact { integer_allocate { 20, id, 3 } }));
    REQUIRE(s.apply(impact { integer_allocate { 30, id, 4 } }));
    ...
    REQUIRE(s.apply(
        impact { integer_deallocate { s.get_integer(id, 2, -1) } }));
    REQUIRE(s.apply(
        impact { integer_deallocate { s.get_integer(id, 3, -1) } }));
    REQUIRE(s.apply(impact { integer_allocate { 20, id, 0 } }));
  ...
  TEST("state copy and edit") {
    ...
    REQUIRE(foo.apply(impact { integer_set { 0, 0, 1 } }));
    while (foo.adjust()) { }
  ...
  TEST("custom io implementation") {
    ...
    REQUIRE(s.apply(impact { tick_continue {} }));
    REQUIRE(!s.adjust());
  }
}
