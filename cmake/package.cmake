...
if(LAPLACE_ENABLE_LIB AND NOT LAPLACE_ENABLE_SHARED)
  set(static_lib_ ON)
else()
  set(static_lib_ OFF)
endif()
...
if(LAPLACE_ENABLE_OBJ OR LAPLACE_ENABLE_LIB)
  macro(laplace_add_headers folder)
    ...
    foreach(path_ ${headers_})
      ...
      install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/source/${folder}/${path_}
...
if(LAPLACE_ENABLE_EXE)
  set_property(TARGET ${QUADWAR_EXE} PROPERTY VERSION ${PROJECT_VERSION})
  set_property(TARGET ${QUADWAR_EXE} PROPERTY SOVERSION ${PROJECT_VERSION_MAJOR})
  set_property(TARGET ${QUADWAR_EXE} PROPERTY INTERFACE_${QUADWAR_EXE}_MAJOR_VERSION ${PROJECT_VERSION_MAJOR})
  set_property(TARGET ${QUADWAR_EXE} APPEND PROPERTY COMPATIBLE_INTERFACE_STRING ${QUADWAR_EXE}_MAJOR_VERSION)

  install(TARGETS ${QUADWAR_EXE}
          EXPORT ${LAPLACE_TARGETS}
          RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR}
          COMPONENT ${QUADWAR_COMPONENT_RUNTIME})
endif()

if(LAPLACE_ENABLE_LIB OR LAPLACE_ENABLE_EXE)
  install(EXPORT ${LAPLACE_TARGETS}
          FILE ${LAPLACE_TARGETS}.cmake
          NAMESPACE ${PROJECT_NAME}::
          DESTINATION "${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME}")

  export(EXPORT ${LAPLACE_TARGETS}
         FILE "${CMAKE_CURRENT_BINARY_DIR}/cmake/${LAPLACE_TARGETS}.cmake"
         NAMESPACE ${PROJECT_NAME}::)
  ...
  write_basic_package_version_file("${CMAKE_CURRENT_BINARY_DIR}/${project_lower_}-config-version.cmake"
